...
// Creating endpoint for popular in anthurium section
app.get('/popularinanthurium',async (req,res)=>{
    let products = await Product.find({category:"anthurium"});
    let popular_in_anthurium = products.slice(0,4);
    console.log("Popular in anthurium fetched");
    res.send(popular_in_anthurium);
})
